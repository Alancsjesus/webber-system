...
const ACESSO_PAPEL = {
  ...
  gestor_planejamento: ['/', '/painel', '/ajuda', '/plano-compras', '/calendario', '/planejamento', '/demanda', '/pesquisa', '/orcamento', '/config/parametros', '/config/areas', '/config/acoes', '/config/naturezas', '/config/elementos', '/config/fontes', '/config/subfontes', '/config/tipo-acao', '/config/tipo-fonte', '/config/conselho-fesp', '/rastreabilidade', '/fesp', '/tramitacao'],
