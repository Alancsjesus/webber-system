...
import SubFonteAdmin from './pages/config/SubFonteAdmin'
...
import TramitacaoIndicadores from './pages/TramitacaoIndicadores'
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="contratos/painel" element={<Guard><PainelContratos /></Guard>} />
          ...
          <Route path="config/subfontes" element={<Guard><SubFonteAdmin /></Guard>} />
          ...
          <Route path="tramitacao/indicadores"     element={<Guard><TramitacaoIndicadores /></Guard>} />
